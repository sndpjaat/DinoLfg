  ...
  return (
    <div className="bg-[#09655A] relative z-[1] -mt-[2px] overflow-hidden" id="Roadmap">
      ...
      <div className="max-w-[1164px] px-3 mx-auto pb-[35px] sm:pb-[60px]">
        <h2
          data-aos="fade-down"
          className="text-[39px] sm:text-[64px] text-white text-center py-5 font-Chewy font-normal leading-[43px] sm:leading-[83px] animate-f ade-in"
        >
          Roadmap
        </h2>
        <div
        ...
        >
          <div className="max-sm:flex-col flex sm:items-center max-sm:ml-[90px] gap-[45px]">
            <h3 className="text-[#FBA11D] text-[100px] lg:text-[200px] font-normal font-Chewy leading-[100px] lg:leading-[261px]">
              01
            </h3>
            <ul>
